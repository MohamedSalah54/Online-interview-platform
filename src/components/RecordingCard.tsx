...
const RecordingCard = ( {recording}: {recording:CallRecording}) => {
    ...
    const duration = recording.start_time && recording.end_time? calculateRecordingDuration(recording.start_time, recording.end_time) : "Unknown"
  return (
    <Card className='group hover:shadow-md transition-all'>
        ...
        {/* card content*/}
        <CardContent>
            <div className='w-full aspect-video bg-muted/50 rounded-lg flex items-center justify-center cursor-pointer group' onClick={() => window.open(recording.url, "_blankk")}>
